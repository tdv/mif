...
#ifndef __MIF_REFLECTION_SERIALIZATION_BOOST_SERIALIZATION_H__
#define __MIF_REFLECTION_SERIALIZATION_BOOST_SERIALIZATION_H__
    ...
    namespace Reflection
    {
        namespace Serialization
        {
            namespace Boost
            {
                namespace Detail
                {
                    ...
                    struct BasesSerializer
                    {
                        ...
                        static void Serialize(TArchive &archive, T &object)
                        {
                            ...
                            archive & boost::serialization::make_nvp(Reflect<BaseType>::Name::GetString().c_str(),
                    ...
                    struct Serializer
                    {
                        ...
                        static void Serialize(TArchive &archive, T &object)
                        {
                            ...
                            using FieldType = typename Reflect<T>::Fields::template Field<I - 1>;
                ...
                {
                    Detail::BasesSerializer<typename Reflect<T>::Base>::Serialize(archive, object);
                    Detail::Serializer<Reflect<T>::Fields::Count>::Serialize(archive, object);
                }
...
#define MIF_BOOST_TYPE_SERIALIZER(type_) \
    ...
    { \
        ...
        { \
            ...
            { \
                ::Mif::Reflection::Serialization::Boost::Serialize(archive, object); \
            } \
        } \
    }

#endif  // !__MIF_REFLECTION_SERIALIZATION_BOOST_SERIALIZATION_H__
