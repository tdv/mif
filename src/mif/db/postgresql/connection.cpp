                ...
                namespace
                {
                    ...
                    private:
                        ...
                        virtual void ExecuteDirect(std::string const &query) override final
                        {
                            ...
                            Statement::ResultPtr result{PQexec(m_connection.get(), query.c_str()),
                        ...
                        {
                            return Service::Make<Statement, IStatement>(m_connection.get(), this, query);
                        }
                    };
...
(
    ...
    Mif::Db::PostgreSql::Detail::Connection,
    std::string,
    std::uint16_t,
    std::string,
    std::string,
